...
void CAGrunt::HandleAnimEvent(AnimEvent_t& event)
{
	...
	case AGRUNT_AE_HORNET5:
		{
			...
			{
			case 0: EMIT_SOUND_DYN(this, CHAN_WEAPON, "agrunt/ag_fire1.wav", 1.0, ATTN_NORM, 0, 100);
				break;
			case 1: EMIT_SOUND_DYN(this, CHAN_WEAPON, "agrunt/ag_fire2.wav", 1.0, ATTN_NORM, 0, 100);
				break;
			case 2: EMIT_SOUND_DYN(this, CHAN_WEAPON, "agrunt/ag_fire3.wav", 1.0, ATTN_NORM, 0, 100);
				break;
			}
	...
	case AGRUNT_AE_LEFT_FOOT:
		...
		{
			// left foot
		case 0: EMIT_SOUND_DYN(this, CHAN_BODY, "player/pl_ladder2.wav", 1, ATTN_NORM, 0, 70);
			break;
		case 1: EMIT_SOUND_DYN(this, CHAN_BODY, "player/pl_ladder4.wav", 1, ATTN_NORM, 0, 70);
			break;
		}
		break;
	case AGRUNT_AE_RIGHT_FOOT:
		...
		switch (RANDOM_LONG(0, 1))
		{
		case 0: EMIT_SOUND_DYN(this, CHAN_BODY, "player/pl_ladder1.wav", 1, ATTN_NORM, 0, 70);
			break;
		case 1: EMIT_SOUND_DYN(this, CHAN_BODY, "player/pl_ladder3.wav", 1, ATTN_NORM, 0, 70);
			break;
		}
		break;
	...
	case AGRUNT_AE_LEFT_PUNCH:
		{
			...
			if (pHurt)
			{
				...
				EMIT_SOUND_DYN(this, CHAN_WEAPON, pAttackHitSounds[RANDOM_LONG(0, ARRAYSIZE(pAttackHitSounds) - 1)],
			...
			else
			{
				...
				EMIT_SOUND_DYN(this, CHAN_WEAPON, pAttackMissSounds[RANDOM_LONG(0, ARRAYSIZE(pAttackMissSounds) - 1)],
				               1.0, ATTN_NORM, 0, 100 + RANDOM_LONG(-5, 5));
			}
		}
		break;
...
void CAGrunt::Precache()
{
	...
	for (i = 0; i < ARRAYSIZE(pDieSounds); i++)
		PrecacheSound((char*)pDieSounds[i]);
